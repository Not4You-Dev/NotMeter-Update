(() => {
  ...
  const COPY = {
    ko: {
      ...
      rankerDungeonGuideDummy: "훈련용 허수아비(1분)는 홈페이지 랭킹과 상위 % 통계를 제공하지만 딜미터기 구간 랭커 마크 대상에서는 제외됩니다.",
    ...
    en: {
      ...
      rankerDungeonGuideDummy: "Training Dummy (1 min) provides website rankings and percentile statistics, but it does not award a live meter CP-bracket rank marker.",
