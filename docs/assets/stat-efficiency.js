(() => {
  ...
  const PROFILE_FIELDS = [
	...
	"allElementDamageAmplificationPercent", "intellectDamageAmplificationPercent",
  ...
  const TEXT = {
    ko: {
      ...
      combatProfile: "전투 조건", combatProfileHelp: "검증을 통과한 지원 보스를 동일 가중치로 종합하며 직업·대표 스킬·방향만 선택합니다.", job: "직업", targetBoss: "분석 보스", targetCollecting: "표본 수집 중", skill: "대표 스킬", overall: "직업 종합", skillLevel: "스킬 레벨", direction: "공격 방향", allDirections: "종합", front: "전방", backDirection: "후방", specializations: "스킬 특성", passives: "패시브·스티그마 레벨", passiveHelp: "특성 선택 없이 실제 레벨만 반영합니다", noPassives: "현재 검증된 패시브·스티그마가 없습니다.", passive: "패시브", stigma: "스티그마", level: "레벨",
      ...
      calculate: "효율 계산", calculating: "계산 중…", resultKicker: "직업·스킬별 분석", resultTitle: "스탯 효율 순위", displayedStatsTitle: "실시간 스탯 시뮬레이션", displayedStatsHelp: "복사 기준에서 입력값을 바꾸면 게임 표시 최종 스탯이 바로 갱신됩니다.", displayedAttack: "최종 공격력", displayedAccuracy: "최종 명중", displayedCritical: "최종 치명타", displayedDefense: "최종 방어력", displayedCooldownTime: "재시전 시간", displayedCombatSpeed: "전투 속도", simulationReset: "복사 기준으로 초기화", simulationDamage: "예상 종합 피해 변화", simulationWaiting: "기준 스탯을 붙여넣으면 자동 계산됩니다.", simulationCalculating: "변경값을 계산하고 있습니다.", simulationCollecting: "피해 효율은 표본 수집 중이며 최종 스탯은 정상 계산되었습니다.", simulationReady: "검증을 통과한 지원 보스를 동일 가중치로 계산한 결과입니다.", waitingTitle: "표본을 수집하고 있습니다", waitingDescription: "선택한 직업·스킬과 충분한 지원 보스가 높은 신뢰 기준을 통과하면 결과가 열립니다.", resultGuide: "+1, +10, +1%p 단위별 순위이며 서로 다른 단위끼리는 직접 비교하지 않습니다.", growthGroup: "주신 스탯 · +1 기준", integerGroup: "전투 수치 · +10 기준", percentGroup: "퍼센트 스탯 · +1%p 기준", easyTitle: "간편하게 사용하는 방법", easyOne: "딜미터기 처치 기록 상단에서 ‘내 스탯 복사’를 누릅니다.", easyTwo: "이 페이지 상단 입력칸에 붙여넣습니다.", easyThree: "대표 스킬·공격 방향을 선택하면 검증을 통과한 지원 보스를 동일 가중치로 종합 계산합니다.",
    ...
    en: {
      ...
      calculate: "Calculate efficiency", calculating: "Calculating…", resultKicker: "CLASS AND SKILL ANALYSIS", resultTitle: "Stat efficiency ranking", displayedStatsTitle: "Live stat simulation", displayedStatsHelp: "Change an input to update the final in-game totals from the copied baseline.", displayedAttack: "Total Attack", displayedAccuracy: "Total Accuracy", displayedCritical: "Total Critical", displayedDefense: "Total Defense", displayedCooldownTime: "Cooldown Time", displayedCombatSpeed: "Combat Speed", simulationReset: "Reset to copied stats", simulationDamage: "Estimated overall damage change", simulationWaiting: "Paste copied stats to start automatic calculation.", simulationCalculating: "Calculating the changed values.", simulationCollecting: "Damage efficiency is collecting samples; final stats were calculated normally.", simulationReady: "Calculated with equal weight across supported bosses that passed validation.", waitingTitle: "Samples are being collected", waitingDescription: "Results unlock after the selected class and skill, plus enough supported bosses, pass high-confidence validation.", resultGuide: "Rankings use +1, +10, and +1%p groups; do not compare different units directly.", growthGroup: "DIVINE STATS · PER +1", integerGroup: "COMBAT VALUES · PER +10", percentGroup: "PERCENT STATS · PER +1%p", easyTitle: "Quick start", easyOne: "Press ‘Copy my stats’ at the top of NotMeter Kill Records.", easyTwo: "Paste into the box at the top of this page.", easyThree: "Choose a skill and direction to calculate across supported bosses that passed validation.", pending: "Unverified", low: "Low confidence", medium: "Medium confidence", high: "High confidence", invalid: "Check the entered values.", unavailable: "Could not reach the calculator. Try again shortly.",
    ...
    "zh-TW": {
      ...
      combatProfile: "戰鬥條件", combatProfileHelp: "通過驗證的支援首領採相同權重綜合，只需選擇職業、技能與方向。", job: "職業", targetBoss: "分析首領", targetCollecting: "正在收集樣本", skill: "代表技能", overall: "職業綜合", skillLevel: "技能等級", direction: "攻擊方向", allDirections: "綜合", front: "正面", backDirection: "背面", specializations: "技能特性", passives: "被動與烙印等級", passiveHelp: "不選特性，只套用實際等級", noPassives: "目前沒有已驗證的被動或烙印。", passive: "被動", stigma: "烙印", level: "等級",
      ...
      calculate: "計算效率", calculating: "計算中…", resultKicker: "職業與技能分析", resultTitle: "屬性效率排名", displayedStatsTitle: "即時屬性模擬", displayedStatsHelp: "變更輸入值後，會從複製基準即時更新遊戲最終屬性。", displayedAttack: "最終攻擊力", displayedAccuracy: "最終命中", displayedCritical: "最終暴擊", displayedDefense: "最終防禦力", displayedCooldownTime: "再使用時間", displayedCombatSpeed: "戰鬥速度", simulationReset: "重設為複製基準", simulationDamage: "預估綜合傷害變化", simulationWaiting: "貼上複製的屬性後即可自動計算。", simulationCalculating: "正在計算變更後的數值。", simulationCollecting: "傷害效率仍在收集樣本，最終屬性已正常計算。", simulationReady: "以通過驗證的支援首領相同權重計算。", waitingTitle: "正在收集樣本", waitingDescription: "所選職業、技能與足夠的支援首領通過高可信度驗證後才會顯示結果。", resultGuide: "排名分為 +1、+10、+1%p 三種單位，不可跨單位直接比較。", growthGroup: "主神屬性 · 每 +1", integerGroup: "戰鬥數值 · 每 +10", percentGroup: "百分比屬性 · 每 +1%p", easyTitle: "快速使用方法", easyOne: "在 NotMeter 討伐紀錄上方按下「複製我的屬性」。", easyTwo: "貼到本頁上方輸入框。", easyThree: "選擇代表技能與方向後，以通過驗證的支援首領綜合計算。", pending: "尚未驗證", low: "低可信度", medium: "中可信度", high: "高可信度", invalid: "請確認輸入值。", unavailable: "無法連線至計算服務，請稍後再試。",
