(() => {
  ...
  const CLIPBOARD_PREFIX = "NOTMETER_STATS_V3:";
  const CLIPBOARD_SCHEMA = "notmeter-stat-efficiency-profile-v3";
  ...
  const PROFILE_FIELDS = [
    "attack", "additionalAttack", "maximumAttack", "criticalAttackPower",
	...
	const INTEGER_EFFECTS = new Set([
		"additionalAttack", "maximumAttack", "criticalAttackPower", "sealstoneAdditionalDamage",
  ...
  const TEXT = {
    ...
    "zh-TW": {
      ...
      attackStats: "攻擊屬性", attackStatsHelp: "使用複製功能即可自動填入。", attack: "攻擊力", additionalAttack: "追加攻擊力", maximumAttack: "最大攻擊力", criticalAttackPower: "暴擊攻擊力", sealstoneAdditionalDamage: "封魂石追加傷害", power: "威力", vitality: "體力", agility: "敏捷", knowledge: "知識", precision: "精準", will: "意志", justice: "正義", freedom: "自由", illusion: "幻象", life: "生命", time: "時間", destruction: "破壞", death: "死亡", wisdom: "智慧", destiny: "命運", space: "空間", accuracy: "命中", pveAccuracy: "PVE 命中", critical: "暴擊", penetration: "貫穿", pveAttack: "PVE 攻擊力", bossAttack: "首領攻擊力", frontAttack: "正面攻擊力", backAttack: "背面攻擊力", frontCritical: "正面暴擊", backCritical: "背面暴擊", percentStats: "增幅與判定屬性", percentStatsHelp: "使用遊戲畫面顯示的原始數值。", damageAmp: "傷害增幅", weaponAmp: "武器傷害增幅", pveAmp: "PVE 傷害增幅", bossAmp: "首領傷害增幅", criticalAmp: "暴擊傷害增幅", additionalHit: "多段命中", perfect: "完美", hardHit: "強擊", cooldownTime: "再使用時間", combatSpeed: "戰鬥速度", frontAmp: "正面傷害增幅", backAmp: "背面傷害增幅",
      calculate: "計算效率", calculating: "計算中…", resultKicker: "職業與技能分析", resultTitle: "屬性效率排名", waitingTitle: "正在收集樣本", waitingDescription: "所有支援首領及所選職業、技能通過高可信度驗證後才會顯示結果。", resultGuide: "排名分為 +1、+10、+1%p 三種單位，不可跨單位直接比較。", growthGroup: "主神屬性 · 每 +1", integerGroup: "戰鬥數值 · 每 +10", percentGroup: "百分比屬性 · 每 +1%p", easyTitle: "快速使用方法", easyOne: "在 NotMeter 討伐紀錄按下「複製我的屬性」。", easyTwo: "貼到本頁上方輸入框。", easyThree: "選擇代表技能與方向後，以所有支援首領綜合計算。", pending: "尚未驗證", low: "低可信度", medium: "中可信度", high: "高可信度", invalid: "請確認輸入值。", unavailable: "無法連線至計算服務，請稍後再試。",
  ...
  const EFFECT_KEYS = {
	...
	additionalAttack: "additionalAttackEffect", maximumAttack: "maximumAttackEffect", criticalAttackPower: "criticalAttackPowerEffect", sealstoneAdditionalDamage: "sealstoneAdditionalDamageEffect",
  ...
  function decodeClipboardProfile(text) {
    ...
    if (!profile || profile.schema !== CLIPBOARD_SCHEMA || profile.version !== 3 ||
