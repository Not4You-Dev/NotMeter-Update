(() => {
  ...
  const COPY = {
    ko: {
      ...
      soulSkillLevel: "총 +{value}레벨", equippedItems: "{value}개 장비",
    ...
    en: {
      ...
      soulSkillLevel: "+{value} levels total", equippedItems: "{value} items",
    ...
    "zh-TW": {
      ...
      soulSkillLevel: "合計 +{value}級", equippedItems: "{value}件裝備",
